 ...
 */
Konekti.media = function(id, media, type, src, config={}, callback=function(){}){ 
	Konekti.add({'plugin':'media', 'setup':['body', id, media, type, src, config]}, callback)
}
 ...
 */
 Konekti.video = function(id, type, src, config, callback){ Konekti.media(id, "video", type, src, config, callback) }
 ...
 */
 Konekti.mp4 = function(id, src, config, callback){ Konekti.media(id, "video", "mp4", src, config, callback) }
 ...
 */
 Konekti.audio = function(id, type, src, config, callback){ Konekti.media(id, "audio", type, src, config, callback) }
 ...
 */
Konekti.mp3 = function(id, src, config, callback){ Konekti.audio(id, "mp3", src, config, callback) }
