 ...
 */
Konekti.navbar = function(id, btns, onclick='', config={}, callback=function(){}){ 
	Konekti.add({'plugin':'navbar', 'setup':['body', id, btns, onclick, config]}, callback)
}